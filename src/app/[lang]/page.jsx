...
function Resume({ hDict }) {
  let resume = [
    ...
    {
      company: hDict.company_dcu_abc,
      localizedCompany: hDict.company_dcu_abc,
      imageClass: 'rounded-full',
      title: hDict.title_officer,
    ...
    {
      company: hDict.company_private_events,
      localizedCompany: hDict.company_private_events,
      title: hDict.title_waiter,
    ...
    {
      company: hDict.company_private_tutor,
      localizedCompany: hDict.company_private_tutor,
      title: hDict.title_tutor,
